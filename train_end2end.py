...
if __name__ == '__main__':
    ...
    for auto_layer in range(1,5):
        ...
        plt.savefig(f'./images/heatmap_test_acc:{n/100}%_AELayer:{auto_layer}_AELoss:{test_loss_ae:.3f}_VGGLoss:{test_loss_cls:.3f}_AE_VGG_end2end.png')   
        ...
        plt.legend()
        plt.savefig(f'./images/loss_test_acc:{n/100}%_AELayer:{auto_layer}_AELoss:{test_loss_ae:.3f}_VGGLoss:{test_loss_cls:.3f}_AE_VGG_end2end.png')
        ...
        plt.legend()
        plt.savefig(f'./images/acc_test_acc:{n/100}%_AELayer:{auto_layer}_AELoss:{test_loss_ae:.3f}_VGGLoss:{test_loss_cls:.3f}_AE_VGG_end2end.png')